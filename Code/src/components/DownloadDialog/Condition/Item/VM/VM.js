...
export default function VM(props) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-around', height: '100%' }}>
      ...
      <DateRangePicker onChange={onCreatedAtChange} label={'Created At'} disableFuture={true} />
      <DateRangePicker onChange={onUpdatedAtChange} label={'Updated At'} disableFuture={true} />
    </div>
  )
}
