...
const FieldTable = React.forwardRef((props, ref) => {
  ...
  const useStyles = makeStyles(() => {
    return {
      ...
      rowCell: Object.assign({}, style ? style.rowCell : {}),
      rowActionCell: Object.assign({}, style ? style.rowActionCell : {}),
    }
  })
        ...
        <ToolbarTitle className={classes.toolbarTitle} >
          {selected.length > 0 ? (
            ...
            <Typography variant='h4' id="tableTitle" className={classes.toolbarTitleText}>
              { L(tableTitle ? tableTitle : 'Field List') }
            </Typography>
          )}
        </ToolbarTitle>
        <Spacer />
        ...
        >
          <TableHead className={classes.header}>
            <TableRow className={classes.headerRow}>
              ...
              {
                headerCellList && headerCellList.map((headCell) => (
                  <TableCell
                    key={headCell.id}
              ...
              dataList && dataList.map((row, index) => {
                return (
                  <StyledTableRow key={'childList_' + index}>
                    ...
                    {
                      headerCellList && headerCellList.map((cell, i) => {
