    ...
    API.detail(id)
      .then(({ data }) => {
        if (data && data.data) {
          ...
          const managerGroup = defaultValue.manager_group && defaultValue.manager_group.name ? defaultValue.manager_group.name : ''
          const supporterGroup = defaultValue.supporter_group && defaultValue.supporter_group.name ? defaultValue.supporter_group.name : ''
          ...
          const list = [
            { id: 'code', label: L('Code'), type: 'text', disabled: true, readOnly: true, value: defaultValue.code },
            { id: 'name', label: L('Name'), type: 'text', disabled: true, readOnly: true, value: defaultValue.name },
            { id: 'mappingGroup', label: L('Mapping Group'), type: 'text', disabled: true, readOnly: true, value: mappingGroup },
            { id: 'managerGroup', label: L('Manager Group'), type: 'text', disabled: true, readOnly: true, value: managerGroup },
            ...
            { id: 'contact_person', label: L('Contact Person'), type: 'searchInput', apiValue: { returnType: returnType.U }, disabled: true, readOnly: true, value: defaultValue.contact_person },
