...
const breadcrumbsList = [{ title: 'AAA Service'}, { title: 'Assign' }]
function AssignList() {
  ...
  // 获取 tenantList、 gourpList 和 roleList
  useEffect(() =>　{
  ...
  useEffect(() => {
    assignApi.list({ ...query, limit: rowsPerPage, page: page+1 })
      .then(response => {
  ...
  return (
    <React.Fragment>
      <NaviHeader title="Assign" breadcrumbsList={ breadcrumbsList } />
