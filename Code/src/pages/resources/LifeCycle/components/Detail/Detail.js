      ...
      if (data && data.data) {
        ...
        const lifeCycleList = [
          ...
          },
          {
            ...
            disabled: true, readOnly: true, value: defaultValue.InventoryID
          },
          {
          ...
          },
          {
            ...
            disabled: true, readOnly: true, value: defaultValue.ActionDetails
          },
          {
            id: 'SuccessorInventoryID', label: L('Successor Inventory ID'), type: 'text',
            disabled: true, readOnly: true, value: defaultValue.SuccessorInventoryID
          },
          {
          ...
          },
          {
            ...
            disabled: true, readOnly: true, value: defaultValue.RespStaff
          },
          {
            id: 'RespStaffDisplayName', label: L('Resp Staff Display Name'), type: 'text',
            disabled: true, readOnly: true, value: defaultValue.RespStaffDisplayName
          },
          {
            id: 'Reason', label: L('Reason'), type: 'text',
            disabled: true, readOnly: true, value: defaultValue.Reason
          },
          {
            id: 'CaseRef', label: L('Case Ref'), type: 'text',
            disabled: true, readOnly: true, value: defaultValue.CaseRef
          },
          {
